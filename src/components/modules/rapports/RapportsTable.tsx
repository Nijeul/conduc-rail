        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-[#263238] text-white font-bold">
              ...
              <th className="text-left px-4 py-3 border-r border-[#ECEFF1]/20">Redacteur</th>
              <th className="text-center px-4 py-3 border-r border-[#ECEFF1]/20">Poste</th>
              ...
              rapports.map((r, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 border-r border-[#ECEFF1] text-center text-lg">
                      {r.posteNuit ? '\uD83C\uDF19' : '\u2600\uFE0F'}
                    </td>

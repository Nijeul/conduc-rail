          ...
          <div className="relative">
            <select
              ...
              onChange={(e) => {
                ...
                // Commit directly with the new value to avoid stale state
...
export function DESheet({ open, onOpenChange, projetId, projetName }: DESheetProps) {
              ...
              <table className="w-full text-left" style={{ fontSize: '12px' }}>
                <thead className="sticky top-0 z-10">
                  <tr style={{ backgroundColor: '#004489' }}>
                    ...
                    <th className="px-2 py-2.5 text-white font-semibold w-[70px]">Unite</th>
                    <th className="px-2 py-2.5 text-white font-semibold text-right w-[100px]">Qte marche</th>

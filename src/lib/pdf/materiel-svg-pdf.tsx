...
function Wheels4Wagon() {
  return (
    <G>
      <Circle cx="18" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="34" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="86" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="102" cy="53" r="5" style={{ fill: '#004489' }} />
    </G>
  )
}
...
function AttelagesWagon() {
  return (
    <G>
      <Rect x="3" y="43" width="5" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="112" y="43" width="5" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
    </G>
  )
}
...
export function LocoSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      ...
      <Rect x="26" y="15" width="5" height="8" rx="1" style={{ fill: '#004489' }} />
      <Ellipse cx="28" cy="15" rx="3" ry="1.5" style={{ fill: '#004489' }} />
      <Rect x="3" y="43" width="6" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="111" y="43" width="6" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
    </Svg>
  )
}
...
export function BallastiereSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Circle cx="18" cy="54" r="5" style={{ fill: '#004489' }} />
      <Circle cx="34" cy="54" r="5" style={{ fill: '#004489' }} />
      <Circle cx="86" cy="54" r="5" style={{ fill: '#004489' }} />
      <Circle cx="102" cy="54" r="5" style={{ fill: '#004489' }} />
      ...
      <Rect x="4" y="46" width="7" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="109" y="46" width="7" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
    </Svg>
  )
}
...
export function BigrueSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Circle cx="12" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="26" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="94" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="108" cy="53" r="5" style={{ fill: '#004489' }} />
      ...
      <Line x1="57" y1="8" x2="32" y2="34" style={{ stroke: '#004489', strokeWidth: 1.5 }} />
      <Line x1="63" y1="8" x2="88" y2="34" style={{ stroke: '#004489', strokeWidth: 1.5 }} />
      <Rect x="52" y="5" width="16" height="5" rx="2" style={{ fill: '#311B92' }} />
      <Rect x="0" y="43" width="5" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="115" y="43" width="5" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
    </Svg>
  )
}
...
export function BMLSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Circle cx="10" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="24" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="60" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="96" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="110" cy="53" r="5" style={{ fill: '#004489' }} />
...
export function RegaleuseSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Circle cx="20" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="100" cy="53" r="5" style={{ fill: '#004489' }} />
      <Rect x="8" y="38" width="104" height="17" rx="2" style={{ fill: '#9E9D24' }} />
      <Polygon points="16,38 44,38 44,50 16,50" style={{ fill: '#E20025', opacity: 0.9 }} />
      ...
      <Polygon points="76,38 104,38 104,50 76,50" style={{ fill: '#E20025', opacity: 0.9 }} />
...
export function StabilisateurSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Circle cx="14" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="30" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="90" cy="53" r="5" style={{ fill: '#004489' }} />
      <Circle cx="106" cy="53" r="5" style={{ fill: '#004489' }} />
...
export function WagonVideSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      <Wheels4Wagon />
      <Rect x="8" y="38" width="104" height="17" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="10" y="26" width="100" height="13" rx="1" style={{ fill: 'none', stroke: '#5A5A5A', strokeWidth: 2.5 }} />
      <Rect x="12" y="28" width="96" height="9" rx="0.5" style={{ fill: '#DCDCDC' }} />
...
export function WagonBallastSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      ...
      <Rect x="10" y="24" width="100" height="15" rx="1" style={{ fill: 'none', stroke: '#5A5A5A', strokeWidth: 2 }} />
      <AttelagesWagon />
    </Svg>
  )
}
...
export function WagonPupitreSVGPDF() {
  return (
    <Svg width={W} height={H} viewBox={VB}>
      ...
      <Rect x="44" y="13" width="32" height="4" rx="1" style={{ fill: '#5A5A5A' }} />
      <Rect x="14" y="32" width="8" height="6" rx="1" style={{ fill: '#004489' }} />
      <Rect x="98" y="32" width="8" height="6" rx="1" style={{ fill: '#004489' }} />
      <AttelagesWagon />
    </Svg>
  )
}
